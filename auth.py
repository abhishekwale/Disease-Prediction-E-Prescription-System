...
def init_auth(app):
    ...
    oauth.register(
        name='oidc',
        authority=os.getenv('COGNITO_AUTHORITY', 'https://cognito-idp.us-east-1.amazonaws.com/us-east-1_Ma2oS5Z2Q'),
        client_id='1fk77ksf112b0jeq0p4kf7luab',
        client_secret=os.getenv('COGNITO_APP_CLIENT_SECRET'),
        server_metadata_url=os.getenv('COGNITO_METADATA_URL', 'https://cognito-idp.us-east-1.amazonaws.com/us-east-1_Ma2oS5Z2Q/.well-known/openid-configuration'),
        client_kwargs={
